...
function Home () {
  ...
  return (
    ...
    <Typography variant="body1"  className={ classes.text }  align="left"> 
      ...
      <br/>
      <br/>
      The frontend is built with React with hooks. The backend is built with Node and Express. Data storage is accomplished with 
      MongoDB and Mongoose. Authentication is done with JSON Web Tokens.  
    </Typography>
    </Box>
    </Grid>
  )
